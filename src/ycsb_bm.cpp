...
#define YCSB_BM
#define UTREE_KEY_T hykv::kv_bm::KeyType8
#include "fixtures/utree_fixture.hpp"

using namespace hykv::kv_bm;

static constexpr char BASE_DIR[] = "/home/jiawen/dbms/tools/ycsb_data";
...
//			DEFINE_BM(fixture, 9010_zipf,    data_zipf_90_10); \  
//			DEFINE_BM(fixture, 5050_zipf,    data_zipf_50_50)
			...
			//DEFINE_BM(fixture, 9010_uniform,    data_uniform_90_10) \  
...
static std::vector<ycsb::Record> data_uniform_90_10;
static std::vector<ycsb::Record> data_zipf_90_10;
