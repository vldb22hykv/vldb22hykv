...
CCEH = ('Cceh', 'CCEH')
HYKV_PMEM = ('PmemVip', 'PMem')
HYKV_DRAM = ('DramVip', 'DRAM')
HYKV_UNALIGNED = ('UnalignedVip', 'Unaligned')

ALL_FIXTURES = [
    HYKV, ROCKS, PMEMKV, HYBRID_FASTER, DASH,
    # HYKV_PMEM,
...
STYLES = {
    ...
    HYKV_PMEM[0]:      Style(PMEM_COLOR, 'o', 10, 'o'),
    HYKV_DRAM[0]:      Style(DRAM_COLOR, 's',  8, '//'),
    HYKV_UNALIGNED[0]: Style('#990000',  's',  8, '//'),
